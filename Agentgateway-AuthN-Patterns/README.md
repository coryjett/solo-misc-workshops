...
| | **[Double OAuth Flow (Eager)](flows/flow-04b-double-oauth-eager-consent/)** | Same trust model as Flow 4, but upstream OAuth runs **up front (eager)** via the gateway issuer — no `PENDING` URL, no separate UI |
