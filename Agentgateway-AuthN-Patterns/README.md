...
| **Token Exchange** | **[Double OAuth Flow](flows/flow-04-double-oauth/)** | OIDC auth + elicitation — two sequential user-facing OAuth flows for downstream auth and upstream API credentials |
