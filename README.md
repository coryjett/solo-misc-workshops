...
- **[Markdown guide with Mermaid diagrams](Agentgateway-Auth-Patterns/agent-gateway-token-flows.md)**
- **[PDF with linked TOC + reference docs](Agentgateway-Auth-Patterns/Agent-Gateway-Token-Flows.pdf)**
